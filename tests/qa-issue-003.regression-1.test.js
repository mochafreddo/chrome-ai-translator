...
exports.tests = [
  {
    name: 'rejects unchanged and partially copied English outside protected atoms',
    fn() {
  ...
  {
    name: 'allows protected technical names and source-owned literal tokens',
    fn() {
  ...
  {
    name: 'normalizes English targets and scopes Korean-only instructions',
    fn() {
      const record = createReasoningRecord();
